        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Apex<span className="text-primary">Rate</span></span>
            </div>
            <p className="text-sm text-slate-400 mb-6">
              The intelligent Sri Lankan exchange rate comparison & forecasting platform. Stop guessing, start comparing.
            </p>
            <div className="flex space-x-4 text-slate-400">
              <a href="#" className="hover:text-primary transition-colors"><TwitterIcon className="h-5 w-5" /></a>
              <a href="#" className="hover:text-primary transition-colors"><GithubIcon className="h-5 w-5" /></a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li><a href="#" className="hover:text-primary transition-colors">Smart Dashboard</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Rate Comparison</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Currency Converter</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Historical Analysis</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li><a href="#" className="hover:text-primary transition-colors">Bank Directory</a></li>
